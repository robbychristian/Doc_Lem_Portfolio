  ...
  sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
    ...
    if (response == "true") {
      sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
        ...
        var firstParagraph = $("#firstParagraph").val();
        var secondParagraph = $("#secondParagraph").val();
        var thirdParagraph = $("#thirdParagraph").val();
        var fourthParagraph = $("#fourthParagraph").val();
        var id = $("#aboutMeId").val();
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/editaboutme", formdata).then(function (response) {
          location.reload();
        }).then(function (e) {
          console.log(e);
        });
